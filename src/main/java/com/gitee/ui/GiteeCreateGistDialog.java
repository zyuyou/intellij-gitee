...
public class GiteeCreateGistDialog extends DialogWrapper {
	...
	@NotNull
	private final GiteeAccountCombobox myAccountSelector;

	public GiteeCreateGistDialog(@NotNull Project project, @NotNull Set<GiteeAccount> accounts, @Nullable GiteeAccount defaultAccount, @Nullable String fileName, boolean secret, boolean openInBrowser, boolean copyLink) {
		super(project, true);
		...
		myAccountSelector = new GiteeAccountCombobox(accounts, defaultAccount, null);
	...
	@NotNull
	public GiteeAccount getAccount() {
		return (GiteeAccount) myAccountSelector.getSelectedItem();
	}
}
