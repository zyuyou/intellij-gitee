...
public class GiteeUtil {
	 ...
	 * 判断是否有关联Gitee的远程仓库
	 * */
	public static boolean isRepositoryOnGitee(@NotNull GitRepository repository) {
		return findGiteeRemoteUrl(repository) != null;
	}

	@Nullable
	public static String findGiteeRemoteUrl(@NotNull GitRepository repository) {
		Pair<GitRemote, String> remote = findGiteeRemote(repository);
		if (remote == null) {
			return null;
		}
	...
	@Nullable
	public static Pair<GitRemote, String> findGiteeRemote(@NotNull GitRepository repository) {
		Pair<GitRemote, String> giteeRemote = null;

		for (GitRemote gitRemote : repository.getRemotes()) {
			for (String remoteUrl : gitRemote.getUrls()) {
				if (GiteeUrlUtil.isGiteeUrl(remoteUrl)) {
	 ...
	 * 添加Gitee远程仓库地址
	 * */
	public static boolean addGiteeRemote(@NotNull Project project,
