...
public class GiteeSharePanel {
  ...
  private final GiteeShareDialog myGiteeShareDialog;

  public GiteeSharePanel(final GiteeShareDialog giteeShareDialog) {
    myGiteeShareDialog = giteeShareDialog;
    myPrivateCheckBox.setSelected(false);

    DocumentAdapter changeListener = new DocumentAdapter() {
      @Override
      protected void textChanged(DocumentEvent e) {
        myGiteeShareDialog.updateOkButton();
      }
    };
