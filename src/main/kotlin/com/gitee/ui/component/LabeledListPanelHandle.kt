...
import com.gitee.pullrequest.ui.details.GEPRMetadataModel
...
internal abstract class LabeledListPanelHandle<T>(protected val model: GEPRMetadataModel,
  ...
  private fun updateControls() {
    ...
    val title = GiteeBundle.message("pull.request.adjustment.failed")
