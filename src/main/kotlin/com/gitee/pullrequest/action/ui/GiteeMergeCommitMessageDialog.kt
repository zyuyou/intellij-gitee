...
package com.gitee.pullrequest.action.ui
...
class GiteeMergeCommitMessageDialog(project: Project,
  ...
  init {
    ...
    setTitle(title)
    setOKButtonText(GiteeBundle.message("merge.commit.dialog.merge.button"))
    init()
  }

  override fun createCenterPanel(): JComponent? {
    return JBUI.Panels.simplePanel(0, UIUtil.DEFAULT_VGAP)
      .addToTop(JLabel(GiteeBundle.message("merge.commit.dialog.message")))
