...
class GEPROpenPullRequestAction : DumbAwareAction(
  GiteeBundle.messagePointer("pull.request.open.action"),
                                                  GiteeBundle.messagePointer("pull.request.open.action.description"),
                                                  null) {
