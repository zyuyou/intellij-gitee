...
internal class GEPRSearchQuery(private val terms: List<Term<*>>) {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is GEPRSearchQuery) return false
  ...
  companion object {
    val DEFAULT = GEPRSearchQuery(listOf(Term.Qualifier.Enum(QualifierName.state, GiteeIssueState.open)))
    val EMPTY = GEPRSearchQuery(listOf())

    private val DATE_FORMAT = SimpleDateFormat("yyyy-MM-dd")

    fun parseFromString(string: String): GEPRSearchQuery {
