...
class GESuggestedChangeApplier(
  private val project: Project,
  private val repository: GitRepository,
  private val suggestedChange: GESuggestedChange
) {
  ...
  private fun createSuggestedChangePatchHunk(suggestedChange: GESuggestedChange): PatchHunk {
  ...
  fun commitSuggestedChanges(commitMessage: String): ApplyPatchStatus {
    ...
    if (exceptions.isNotEmpty()) {
      ...
      GiteeUtil.LOG.error("Failed to commit suggested change", *messages)
  ...
  private fun createSuggestedChangePatch(suggestedChange: GESuggestedChange): TextFilePatch {
