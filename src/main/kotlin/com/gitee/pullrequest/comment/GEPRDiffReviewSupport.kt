...
interface GEPRDiffReviewSupport {
  ...
  companion object {
    val KEY = Key.create<GEPRDiffReviewSupport>("Github.PullRequest.Diff.Review.Support")
    val DATA_KEY = DataKey.create<GEPRDiffReviewSupport>("Github.PullRequest.Diff.Review.Support")
  }
}