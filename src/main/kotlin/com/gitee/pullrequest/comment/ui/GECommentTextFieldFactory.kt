...
class GECommentTextFieldFactory(private val model: CommentTextFieldModel) {

  fun create(
    @NlsContexts.Tooltip actionName: String = GiteeBundle.message("action.comment.text"),
    onCancel: (() -> Unit)? = null
  ): JComponent {
  ...
  fun create(
    avatarIconsProvider: GEAvatarIconsProvider, author: GiteeUser,
    @NlsContexts.Tooltip actionName: String = GiteeBundle.message("action.comment.text"),
    onCancel: (() -> Unit)? = null
  ): JComponent {
