...
internal class GiteePullRequestSearchPanel(project: Project,
                                           private val autoPopupController: AutoPopupController,
                                           private val holder: GiteePullRequestSearchQueryHolder)
  ...
  private val searchField = object : TextFieldWithCompletion(project, SearchCompletionProvider(), "", true, true, false, false) {
    ...
    override fun updateUI() {
      super.updateUI()
      GiteeUIUtil.setTransparentRecursively(this)
    }
  }
  ...
  private fun updateQuery() {
    holder.query = GiteePullRequestSearchQuery.parseFromString(searchField.text)
  }
    ...
    override fun addCompletionVariants(text: String, offset: Int, prefix: String, result: CompletionResultSet) {
      ...
      if (qualifierName == null) {
        ...
        qualifierName.equals(GiteePullRequestSearchQuery.QualifierName.sortBy.name, true) -> {
          for (sort in GiteeIssueSearchSort.values()) {
