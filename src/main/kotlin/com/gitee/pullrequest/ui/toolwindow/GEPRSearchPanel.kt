...
object GEPRSearchPanel {
  ...
  fun create(project: Project,
             ...
             pullRequestUiSettings: GiteePullRequestsProjectUISettings
  ): JComponent {
    ...
    showSearchHistoryButton = InplaceButton(
      IconButton(
        GiteeBundle.message("pull.request.list.search.history", KeymapUtil.getFirstKeyboardShortcutText(SHOW_SEARCH_HISTORY_ACTION)),
