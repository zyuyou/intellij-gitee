...
class GEPRReviewThreadDiffComponentFactory(project: Project, editorFactory: EditorFactory) {
  ...
  fun createComponent(diffHunk: String, startLine: Int?): JComponent {
    try {
      val patchReader = PatchReader(GEPatchHunkUtil.createPatchFromHunk("_", diffHunk))
