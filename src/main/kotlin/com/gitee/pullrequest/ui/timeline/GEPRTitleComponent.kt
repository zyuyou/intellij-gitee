...
import com.gitee.pullrequest.ui.details.GEPRDetailsModel
...
internal object GEPRTitleComponent {
  ...
  fun create(project: Project, model: SingleValueModel<GiteePullRequest>, detailsDataProvider: GEPRDetailsDataProvider): JComponent {
    val icon = JLabel()
