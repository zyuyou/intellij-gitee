 ...
 *
 */
package org.intellij.gitee.api.requests;
...
public class GiteeGistRequest {
  ...
  public GiteeGistRequest(@NotNull List<FileContent> files, @NotNull String description, boolean isPublic) {
